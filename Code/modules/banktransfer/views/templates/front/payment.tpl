    ...
    <section id="main" style="margin-bottom: 1.563rem;">
        <div class="row product-container js-product-container" style="display: flex; flex-direction: column; align-items: center; gap: 1rem; text-align: center;">
            ...
            <div class="col-md-6" style="margin: auto; ">
                <p style="text-align:left;">Bank details</p>
                <table class="table table-bordered" style"border-collapse: collapse; width: 100%;">
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td style="border: 2px solid #969696;  text-align:left; padding:0.8em 1.5em;">สมาคมศิษย์เก่าวิทยาลัยการคอมพิวเตอร์</td>
                        </tr>
                        <tr>
                            <td style="border: 2px solid #969696;  text-align:left; padding:0.8em 1.5em;">Account Number</td>
