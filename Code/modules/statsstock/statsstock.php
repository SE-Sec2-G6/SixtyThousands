...
//                 . '</td>
// 					</tr>
//                     <!-- Deny order if out of stock -->
//                     <tr>
//                         <td colspan="6">
//                             <p><strong>' . $this->trans('Ordering not allowed when out of stock.', [], 'Modules.Statsstock.Admin') . '</strong></p>
//                         </td>
//                     </tr>
// 				</tfoot>
// 			</table>
...
//             // Check if any product is out of stock, then deny order
//             foreach ($products as $product) {
