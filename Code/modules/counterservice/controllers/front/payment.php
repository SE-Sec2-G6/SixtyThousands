...
class CounterServicePaymentModuleFrontController extends ModuleFrontController
{
    ...
    public function initContent()
    {
        ...
        $this->setTemplate('module:counterservice/views/templates/front/payment.tpl');
    }
